package info.kzthink.polls.service;
...
public class PollService {
    ...
    public PagedResponse<PollResponse> getAllPolls(UserPrincipal currentUser, int page, int size) {
        ...
        // Map Polls to PollResponses containing vote counts & poll creator details
    ...
    public PagedResponse<PollResponse> getPollsCreatedBy(String username, UserPrincipal currentUser, int page, int size) {
        ...
        // Retrieve all polls created by given username
        Pageable pageable = new PageRequest(page, size, Sort.Direction.DESC, "createdAt");
    ...
    private Map<Long, Long> getPollUserVoteMap(UserPrincipal currentUser, List<Long> pollIds) {
        // Retreive Votes done by the logged in user to the given pollIds
